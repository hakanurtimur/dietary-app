  ...
  return (
    <li className={classes.list}>
      <div className={classes.li}>
        ...
        <span className={classes.amount}><div className={classes.number}>{totalAmount.cho}</div><div>Total Gram (CHO)</div></span>
        <span className={classes.amount}><div className={classes.number}>{totalAmount.prt}</div><div>Total Gram (PRT)</div></span>
        <span className={classes.amount}><div className={classes.number}>{totalAmount.fat}</div><div>Total Gram (FAT)</div></span>
        <span className={classes.amount}><div className={classes.number}>{totalAmount.cal}</div><div>Total Cal(kcals)</div></span>
